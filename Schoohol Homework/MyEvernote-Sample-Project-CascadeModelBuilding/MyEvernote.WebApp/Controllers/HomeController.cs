...
namespace MyEvernote.WebApp.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //Taslakları gizlemek için kullanılır...
        ...
        public ActionResult ByCategory(int? id)
        {
            ...
            //List<note> notos= cat.Notes.Where(
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //registerOk silerek kurduğumuz okviewde yönlendirme yapılacak
                ...
                //İtemları dolduruzu aksi halde hata alırız
                ...
                return View("Ok", notifyObj);//notifyobj de alarak ok sayfasına göster.
            }
